...
public static class SetsAndMaps
{
    ...
    {
        if (c >= 'a' && c <= 'z') // This one here is to check if the character is a lowercase letter
        {
            charCounts[c - 'a']++; 
        }
    }
    ...
    {
        if (c >= 'a' && c <= 'z') // This is to check if the character is a lowercase letter
        {
            charCounts[c - 'a']--;
            if (charCounts[c - 'a'] < 0) 
                return false;
    ...
    // THen this one is to check if all character counts are zero
